...
4. **Product Collection Image Set**
    ...
    - At least 4 e\-commerce\-ready product visuals:
...
6. **A/B Testing Plan**
    ...
    - Which creative route is A vs B

    - Suggested success metrics

    - Expected learning from the test

7. **Optional Performance Learning**

    - If past campaign data is provided, the system may recommend:
...
### Problem Fit \& Practical Usefulness — 20 pts
