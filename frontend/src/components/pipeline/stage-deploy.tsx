...
export const StageDeploy: React.FC = () => {
  const [status, setStatus] = React.useState<Record<Platform, DeployState>>({ tiktok: "idle", shopee: "idle" });
  ...
  return (
    <div className="space-y-4">
      ...
      <button type="button" onClick={() => deploy(["tiktok", "shopee"])} disabled={isBusy || allLive} className="h-10 px-5 bg-[#35ea52] text-black text-xs font-mono font-bold inline-flex items-center justify-center gap-2 hover:bg-[#35ea52]/85 disabled:opacity-60">
